...
const asciiTo8bit = str => {
  return str.split('').map(char => addZeros(char.charCodeAt().toString(2), 8)).join('');
};
...
// 1001000110010111011001101100110111110110010000011101111101111111001011011001100100100001
